...
import { extractQuery } from './services/string.services';
...
export class HttpApi implements IHttpApi {
  constructor(baseApiUrl: string = '', loginPage: string = '') {
    ...
    try {
      const qry = extractQuery(window.location.href).query;
      this.queryParams = qs.parse(qry, { ignoreQueryPrefix: true }) || {};
      //console.log('qs', this.queryParams);
    } catch (e) {
    }
